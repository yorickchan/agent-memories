...
Full verb details: [memory.md](packages/mcp/references/memory.md) · [kg.md](packages/mcp/references/kg.md) · [wm.md](packages/mcp/references/wm.md).
...
- [Knowledge Graph verbs](packages/mcp/references/kg.md) - `kg.upsert_node`, `kg.upsert_edge`, `kg.neighborhood`, `kg.get_node`, `kg.graph`, `kg.search`
